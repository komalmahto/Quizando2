      ...
      >
        ...
        <div className="vertical__options">
          <ul className="vertical__nav__menu">
            ...
            <li>
              <img src="https://www.quizando.com/assets/how_to_play.png" />{" "}
              <a href="#">How to Play?</a>
            </li>
            <li>
              <img src="https://www.quizando.com/assets/meet_the_hosts.png" />{" "}
            ...
            <li>
              <img src="https://www.quizando.com/assets/meet_the_hosts.png" />{" "}
              <a href="#">Go To Partner Account</a>
            </li>
            <li className="menu__title">
              <a href="#" style={{ color: "white" }}>
                Other
            ...
            <li>
              <img src="https://www.quizando.com/assets/about.png" />{" "}
              <a href="#">About</a>
            </li>
            <li>
              <img src="https://www.quizando.com/assets/t_and_c.png" />{" "}
              <a href="#">Terms & Conditions</a>
            </li>
            <li>
              <img src="https://www.quizando.com/assets/contact_us.png" />{" "}
              <a href="#">Contact us</a>
            </li>
          </ul>
        </div>
